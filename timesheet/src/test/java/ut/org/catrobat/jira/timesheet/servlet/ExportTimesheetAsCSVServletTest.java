...
public class ExportTimesheetAsCSVServletTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(timesheetService.getTimesheetByUser(userProfile.getUserKey().getStringValue(), false)).thenReturn(timesheet);
    ...
    public void testDoGet() throws Exception {
        Timesheet sheet0 = timesheetService.getTimesheetByUser(userProfile.getUserKey().getStringValue(), false);
